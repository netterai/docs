...
description: Configure outbound webhooks to receive real-time events. Register endpoints, subscribe to event types, and verify delivery with signing secrets.
---
...
<Steps>
  ...
  <Step title="Select events">
    ...
    {/* TODO: Restore link once the "event types" page is published. Previously linked to /integrations/webhooks/event-types, which does not exist. */}
    The full list of event types and payload schemas is shown inline in the event selector.
  </Step>
