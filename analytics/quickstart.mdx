...
description: Get started with Analytics in minutes. Connect your first data source, build a dashboard, and explore charts, filters, and reporting basics.
---
...
- Experiment with different chart types to find the right visualization for your data.
